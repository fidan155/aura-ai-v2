        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#1E2530] bg-[#12161D]">
              ...
              <span className="font-mono text-[11px] text-[#7C8494] uppercase tracking-wide">
                Nutzerbereich
              </span>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto pt-32 pb-24 px-6 relative z-10 space-y-12">
        <motion.div {...fadeIn}>
          ...
          <p className="text-[#7C8494] max-w-xl">
            Erstelle neue Anträge oder verwalte deine dezentralisierten Nodes.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-5">
            <motion.div
              ...
              className="p-6 rounded-2xl bg-[#12161D] border border-[#1E2530]"
            >
          ...
          >
            <h3 className="font-display font-semibold text-xl flex items-center gap-2">
              <PlusCircle className="w-5 h-5 text-[#F5A623]" /> Neuer
              Core-Antrag
            </h3>
            ...
            <form onSubmit={handleAntragSubmit} className="space-y-4 pt-2">
              ...
              >
                {isSubmitting ? (
                  <>
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" /> Wird
                    gesendet...
                  </>
                ) : (
                  'Antrag absenden'
        ...
        >
          <h3 className="font-display font-semibold text-lg mb-4">
            Deine eingereichten Anträge & Status
          </h3>
            ...
            <Table className="">
              <TableHeader className="border-[#1E2530] bg-[#12161D]">
                <TableRow className="border-[#1E2530] hover:bg-transparent">
                  ...
                  <TableHead className="text-right font-mono text-[#4CC9F0]">
                    Status
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody className="">
                {antraegeListe.length === 0 ? (
                  ...
                  antraegeListe.map((antrag) => {
                    const statusText = antrag.status
                      ? antrag.status.toUpperCase()
                      : 'OFFEN';
                    const statusColor =
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          className={`text-right font-semibold font-mono ${statusColor}`}
                        >
                          {statusText}
                        </TableCell>
                      </TableRow>
